...
//
// The Serial Port Subtypes for ARM are documented in Table 3 of the DBG2
// Specification
//
...
/// ARM DCC
///
#define EFI_ACPI_SERIAL_PORT_CONSOLE_REDIRECTION_TABLE_INTERFACE_TYPE_ARM_DCC                   0x0f
